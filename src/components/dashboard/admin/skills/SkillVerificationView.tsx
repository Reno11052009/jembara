...
export default function SkillVerificationView({ items }: { items: Item[] }) {
  ...
  return <div className="space-y-4">
    ...
    </article>) : <p className="rounded-xl border border-dashed border-hairline bg-card p-8 text-center text-ink-muted">{dict.common.noData}</p>}
  </div>;
}
