    ...
    <div className="rounded-xl border border-hairline bg-card p-3">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-base text-ink-muted">{project.companyName}</p>
        </div>
      ...
      <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex gap-6 text-base">
          <div>
            ...
            <p className="mt-0.5 font-black font-display text-xl text-ink">{project.budgetLabel}</p>
          </div>
          <div>
            <p className="text-ink-muted">Deadline</p>
            <p className="mt-0.5 font-black text-xl text-ink">{project.deadlineLabel}</p>
          </div>
        </div>
      ...
      <div className="mt-4 flex items-center justify-between gap-3">
        <Button variant="ghost" className="border-2 border-outline-black">
          LAMAR PROJECT
        </Button>
