...
export default function UpcomingWithdrawalCard({
  ...
  return (
    <div className="rounded-xl border border-hairline bg-card p-5">
      <h3 className="font-display text-base font-black text-ink">{t.earningsCards.upcomingWithdrawalTitle}</h3>
      <div className="mt-4 flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <p className="font-body text-sm text-ink-muted">{t.earningsCards.amount}</p>
          <p className="font-display text-sm font-black text-ink">
            {withdrawal.amountLabel}
          </p>
        </div>
        <div className="flex items-center justify-between">
          <p className="font-body text-sm text-ink-muted">{t.earningsCards.date}</p>
          <p className="font-display text-sm font-black text-ink">
            {withdrawal.dateLabel}
          </p>
        </div>
        <div className="flex items-center justify-between">
          <p className="font-body text-sm text-ink-muted">{t.earningsCards.status}</p>
