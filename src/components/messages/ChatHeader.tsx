...
export default function ChatHeader({
  ...
  return (
    <div className="flex items-center justify-between border-b border-hairline px-4 sm:px-6 py-3.5 sm:py-4">
      <div className="flex items-center gap-2 sm:gap-3">
        {onBack && (
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-lg border border-hairline text-ink transition-colors hover:border-brand hover:text-brand lg:hidden"
          >
            <ChevronLeft size={20} />
          </button>
        )}
        ...
        >
          <span className="relative flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-full bg-brand-soft text-xs sm:text-sm font-display font-black text-brand transition-transform group-hover:scale-105">
          ...
          <div className="min-w-0">
            <p className="truncate font-display text-sm sm:text-base font-black text-ink transition-colors group-hover:text-brand">
              {conversation.contactName}
            </p>
      ...
      <div className="relative" ref={menuRef}>
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-hairline text-ink-muted transition-colors hover:border-brand hover:text-brand"
        >
        ...
        {isMenuOpen && (
          ...
          >
            ...
            >
              ...
              {isBlocked ? "Buka Blokir" : "Blokir Kontak"}
            </button>
          </div>
        )}
      </div>
