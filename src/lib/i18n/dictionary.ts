...
const dictionary: Record<Language, Dictionary> = {
  id: {
    ...
    auth: {
      ...
      shellHeroTitle: "Cari kerja itu proses matchmaking.",
      shellHeroDesc: "Bukan sekadar kirim CV — sistem kami mencocokkan skill-mu dengan role yang benar-benar cocok.",
  ...
  en: {
    ...
    auth: {
      ...
      shellHeroTitle: "Job hunting is a matchmaking process.",
      shellHeroDesc: "Not just sending CVs — our system matches your skills with roles that truly fit.",
  ...
  ja: {
    ...
    auth: {
      ...
      loginText: "ログイン",
      shellHeroTag: "創作の架け橋",
      shellHeroTitle: "就職活動はマッチメイキングです。",
      shellHeroDesc: "単に履歴書を送るだけでなく、当システムがあなたのスキルと本当に適した役割をマッチングします。",
